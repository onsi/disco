...
var _ = Describe("Clock", func() {
	DescribeTable("NextSaturday", func(input, output time.Time) {
		...
		Entry("when it's before Saturday at 10",
			time.Date(2023, time.September, 26, 13, 07, 35, 0, saturdaydisco.Timezone),
			time.Date(2023, time.September, 30, 10, 0, 0, 0, saturdaydisco.Timezone),
		),
		Entry("when it's just before Saturday at 10",
			time.Date(2023, time.September, 30, 9, 59, 59, 0, saturdaydisco.Timezone),
			time.Date(2023, time.September, 30, 10, 0, 0, 0, saturdaydisco.Timezone),
		),
		Entry("when it's just after Saturday at 10",
			time.Date(2023, time.September, 30, 10, 0, 01, 0, saturdaydisco.Timezone),
			time.Date(2023, time.October, 7, 10, 0, 0, 0, saturdaydisco.Timezone),
		),
		Entry("no problem at leap years",
			time.Date(2024, time.February, 28, 12, 0, 0, 0, saturdaydisco.Timezone),
			time.Date(2024, time.March, 2, 10, 0, 0, 0, saturdaydisco.Timezone),
		),
	)
